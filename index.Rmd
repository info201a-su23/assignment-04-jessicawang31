...
The problem domain of incarceration in America is a significant issue with a great number of its population behind bars.I'll be analyzing the total population of people in America incarcerated, comparing the differences between states/counties and how a person's demographic such as race may play a role as a significant amount of the people behind bars are part of the Black community. I'm analyzing these variables to gain insights to potential trends that may be occurring and see if there's correlation between variables such as race. 
...
- What is the average for my variable for each county? 
...
I found 5 values computed from the dataset I chose, analyzing the "black_prison_pop" column. The first value I calculated was the average number of black people in prison in each county, spanning from the year 1970-2018. The second value I calculated was what county and what year the highest number of black people in prison was which was New York County in 1998 with a value of 24818. The third value I calculated was what county and what year the lowest number of black people in prison was, this one had multiple counties with the value of 0, however, there are way too many to print so my code prints the one at the top of the list of counties with a value of 0 instead. My fourth and fifth values I calculated were more in depth as I chose King County, WA to analyze. One value calculated was the how the male black prison population changed in the last 10 years and how the female black prison population changed in the last 10 years, yielding a value of 184 for males adn 36 for females.
