...
I found 5 values computed from the dataset I chose, analyzing the "black_prison_pop" column. The first value I calculated was the county with the greatest average number of black people in prison, spanning from the year 1970-2018, yielding New York County and an average of 19141. The name of this variable is max_black_average_population_row. I chose to do the max county as if I did the average for each county, there would be over 1000 values. The second value I calculated was what county and what year the highest number of black people in prison was which was New York County in 1998 with a value of 24818. The variable name of this value is highest_incarceration_counties. The third value I calculated was what county and what year the lowest number of black people in prison was, this one had multiple counties with the value of 0, however, there are way too many to print so my code prints the one at the top of the list of counties with a value of 0 instead. The variable name of this is lowest_incarceration_county. My fourth and fifth values I calculated were more in depth as I chose King County, WA to analyze. One value calculated was the how the male black prison population changed in the last 10 years and how the female black prison population changed in the last 10 years, yielding a value of 184 for males and 36 for females. The variable name for both of these was change_over_years but one just filtered for the men and the other the female.
